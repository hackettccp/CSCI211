...
class MinHeap {
                ...
                if(left != NULL) {
                    ...
                    if(right != NULL) {
                        ...
                        if(left->value < right->value) {
                            //Left child is the smaller of the two
                            if(v > left->value) {                           //Value is greater than the left child
                                ...
                                break;                                      //Value was not greater than the left child (or right child for that matter); We're done promoting children
                            }
                        }
                        else {
                            //Right child is the smaller of the two
                            if(v > right->value) {                          //Value is greater than the right child
                                ...
                                break;                                      //Value was not greater than the right child (or left child for that matter); We're done promoting children
                            }
                        }
                    ...
                    //No right child
                        ...
                        if(v > left->value) {                               //Value is greater than the left child
                            ...
                            break;                                          //Value was not greater than the left child; We're done promoting children
                        }
                    }
                }
    ...
    public:
        ...
        void add(int value) {
            ...
            while(p >= 1) {
                if(array[p]->value > value) {               //Parent's value is larger
