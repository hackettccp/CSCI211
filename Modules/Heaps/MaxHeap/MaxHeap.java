    ...
    public void add(HeapObject data) {
        ...
        while(p >= 1) {
            if(array[p].getData() < array[i].getData()) {
                //Parent is smaller, so swap the objects
                swap(p, i);
            }
            ...
            if(left != null) {
                ...
                if(right != null) {
                    ...
                    if(left.getData() > right.getData()) {
                        //Left child is largest of the two
                        if(o.getData() < left.getData()) {
                            //If left child is larger, swap them
                        ...
                        //Right child is largest of the two
                        if(o.getData() < right.getData()) {
                            //If right child is larger, swap them
                    ...
                    //If left child is greater, swap them
                    if(o.getData() < left.getData()) {
                        swap(i, getLeftChildIndex(i));
                        i = getLeftChildIndex(i);
                        continue;
